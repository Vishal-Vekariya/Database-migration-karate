...
public class SecurityAdminRoleIntegrationTest {
    @Autowired
    ...
    @Test
    void adminCanCreatePractitioner() throws Exception {
        mockMvc.perform(post("/practitioners")
                ...
                .andExpect(jsonPath("$.firstName").value("Kungfu"));
    }

    @Test
    void adminCanUpdatePractitioner() throws Exception {
    ...
    @Test
    void adminCanDeletePractitioner() throws Exception {
